...
export const Route = createFileRoute("/broker-bounties")({
  ...
  component: BrokerBountiesPage,
});

export default function BrokerBountiesPage() {
  ...
  return (
    <div className="space-y-6 p-6">
      <PageHeader
        ...
        subtitle="Configure the 25% customer advance split, set default flat-fee agent bounties, and process manual bank payouts for loaded trips."
      />
